...
import com.ayoview.sample.ztmpl_listview.http.TestHttper;
import com.ayoview.sample.ztmpl_listview.http.TestOrder;
import com.ayoview.sample.ztmpl_listview.http.TestOrderList;
...
public class TmplFragment extends BaseListViewFragment<TmplBean> {
	...
	public PullToRefreshListView findListView() {
		return (PullToRefreshListView) getRootView().findViewById(R.id.lv_articles);
	}
