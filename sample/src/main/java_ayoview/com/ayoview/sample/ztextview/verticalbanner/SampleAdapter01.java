 ...
 * Time: 下午2:05<br/>
 */
public class SampleAdapter01 extends VerticalBannerAdapter<Model01> {
    ...
    public View getView(VerticalBannerView parent) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.verticalbanner_item_01,null);
    }
