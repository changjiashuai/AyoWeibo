...
public abstract class BaseListViewFragment<T> extends AyoFragment implements OnViewClickListener<T> {
    ...
    public abstract PullToRefreshListView findListView();
	...
	private void initListView() {
		...
		lv_articles.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
