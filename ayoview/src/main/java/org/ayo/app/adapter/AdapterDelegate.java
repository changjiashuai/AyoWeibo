...
public interface AdapterDelegate<T> {
   ...
   */
  @NonNull public AyoViewHolder onCreateViewHolder(ViewGroup parent);
   ...
   */
  public void onBindViewHolder(@NonNull T items, int position, @NonNull AyoViewHolder holder);
}
