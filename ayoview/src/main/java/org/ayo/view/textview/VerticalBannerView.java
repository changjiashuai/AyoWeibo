...
public class VerticalBannerView extends LinearLayout implements VerticalBannerAdapter.OnDataChangedListener {
    ...
    private VerticalBannerAdapter mAdapter;
     ...
     * 设置banner的数据
     * */
    public void setAdapter(VerticalBannerAdapter adapter){
        if(adapter == null){
