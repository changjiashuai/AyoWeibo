 ...
 * 微博列表页
 */
public class TimelineListFragment4 extends AyoRecyclerViewFragment implements ISubPage{
...
//                    callback);
            ...
            //获取我和我关注的人的微博，只在本应用授权的用户才行
            ApiTimeLine.getPublicTimelinesByMyFriends("获取我发布的微博",
                    cond.access_token,
                    cond.pageSize,
                    cond.pageNow,
                    callback);
