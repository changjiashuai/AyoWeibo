...
public class Pop {
    ...
    private void createDialog() {
        if (yah != null) {
            int buttonId = yahButtonName != 0 ? yahButtonName : R.string.pop_ok;
        ...
        if (nah != null) {
            int buttonId = nahButtonName != 0 ? nahButtonName : R.string.pop_cancel;
        ...
        if (aah != null) {
            int buttonId = aahButtonName != 0 ? aahButtonName : R.string.pop_neutral;
            builder.setNegativeButton(buttonId, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
    ...
    public AlertDialog show(@NonNull View popView) {
